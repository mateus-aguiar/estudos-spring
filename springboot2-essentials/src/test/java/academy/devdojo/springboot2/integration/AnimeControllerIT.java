...
public class AnimeControllerIT {
    ...
    @LocalServerPort // usado para descobrir qual porta a aplicacao esta usando
    private int port;
    @Autowired
    ...
    void findByName_ReturnsEmptyListOfAnime_WhenAnimeIsNotFound() {
        List<Anime> animes = testRestTemplate.exchange("/animes/find?name=teste", HttpMethod.GET, null,
                new ParameterizedTypeReference<List<Anime>>() {
                }).getBody();
